...
def get_color_block(col, row):
    ...
    if col >= 3 and col <= 12 and row <= 7: return "blue!20"
    return "green!20"
...
\caption{Das klassische Periodensystem der Elemente (Heutiger Stand der Materie)}
\end{figure}
"""

os.makedirs(OUT_DIR, exist_ok=True)
with open(os.path.join(OUT_DIR, "ptable_standard.tex"), "w", encoding="utf-8") as f:
    f.write(tex_code)
